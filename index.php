...
$newBookQuery -> execute([
  ...
  'author' => $author,
  'year' => $year]);
// There is no need to use the fetch() method since we won't be checking return data
